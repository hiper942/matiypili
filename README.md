...
Descripción: 
Mati & Pili es un videojuego de plataformas cooperativo en el cual dos personajes muy distintos entre sí; Mati, un niño curioso y alocado, y Pili, una gigante piedra pacífica; deben avanzar por un bosque mágico resolviendo puzzles enfocados en la colaboración, unión de habilidades, altura y tiempo.
...
### Personajes
#### Mati
[](https://github.com/hiper942/matiypili/blob/main/img/Matias_Concepto.png?raw=true)
...
#### Pilar
[](https://github.com/hiper942/matiypili/blob/main/img/Pilar_Concepto.png?raw=true)
...
#### Enemigos
[](https://github.com/hiper942/matiypili/blob/main/img/EspirituPeque_Concepto.png?raw=true)
...
Música ambiental suave acorde al bosque.
...
- Raíces profundas: puzzles de mayor complejidad.
...
- Bosque lumínico: espacio nocturno con puzzles jugando con las luces.
...
Puzzle: Mati debe accionar un puente para Pili.
Enemigos: raíces errantes.

### NIVEL 3 - Raíces profundas
Objetivo: mayor unión entre jugadores.
Puzzle: ambos deben accionar placas a la vez.
...
Puzzle: abrir paso entre las cascadas para Mati con Pili.
...
Objetivo: introducción a puzzles con luces.
Enemigos: plantas dormilonas.
...
[FOTO DIAGRAMA]()
### Dificultad
En escala suave. La curva de aprendizaje se apoya en la cooperación de ambos más que en la misma complejidad en parkour o puzzles.
